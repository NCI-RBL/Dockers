...
testing="N"
if(testing=="Y"){
  sample_manifest  = "/data/RBL_NCI/Wolin/mov10_par_Y_r2_01062023/manifests/samples.tsv"
  multiplex_manifest = "/data/RBL_NCI/Wolin/mov10_par_Y_r2_01062023/manifests/multiplex.tsv"
  barcode_input = "/data/RBL_NCI/Wolin/mov10_par_Y_r2_01062023/sam_testing/barcode_counts.txt"
  output_dir = "./"
  mismatch = 1
  mpid="CLIP"
}
