...
if __name__== '__main__':
    ...
    parser.add_argument('--ncrnaDir', default= './index/rna/star_hg19_ncrna', help= 'index for ncRNA depletion')
    parser.add_argument('--genomeDir', default= './index/hg19/star_hg19', help= 'index for genomic alignment')
