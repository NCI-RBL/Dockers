...
infile,GFFfilepath,outfile= sys.argv[1], sys.argv[2], sys.argv[3]

#GFFfilepath= '/mnt/rnabl-work/Guiblet/CCBRRBL8/index/hg19/CanonicalTranscriptKnownGeneCoding.gtf'
#GFFfilepath= 'index/hg19/CanonicalTranscriptKnownGeneCoding.gtf'
...
#outfile= 'HTSeq/%s_counts.txt' %(file)
