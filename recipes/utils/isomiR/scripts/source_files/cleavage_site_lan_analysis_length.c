...
// July-24-2018
// This modification took place in Aug 16, 2016. The resulting exe file is lan_length.exe.
// The nature of this modification is to simply (skip) some details of output and leave only info regarding length
// These note is added July-24-2018 based on re-reading of the codes.
...
//********************************************************************
    ...
    if (reads_analyzed != 0)
    {
        ...
        printf("%f%%\n", (float) reads_analyzed * 100.0 / (float) total );
