...
int main(int argc, char* argv[])		
{
    ...
    long int 	num_read = 0,  contain_adaptors = 0, too_short = 0, no_adaptors=0;
	...
	fprintf(stderr, "number of reads do not have adaptor :       %ld, that is %ld%% of total reads\n", no_adaptors, no_adaptors*100/num_read);
