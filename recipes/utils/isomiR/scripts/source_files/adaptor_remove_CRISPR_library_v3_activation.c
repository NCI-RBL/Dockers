...
// 2019 July 3rd
// Modified the 3' adaptor sequence to make it useable for activation screen.
...
#define ADAPTOR_tracrRNA		"GTTTTAGAGCTAGGCCAACA"          //  the new sequence for activation sgRNAs!
#define	MISMATCH_5          1
#define MISMATCH_3          1
