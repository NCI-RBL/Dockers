...
// 2019 March 29, modify the adaptor sequence to make this scripts work for testing genomic sequences of CRISPR target -- Xavier's design.
...
#define ADAPTOR		"TGGAATTCTCGGGTGCCAAGGA"
